...
使用建议：
- 先阅读执行手册，再按本清单创建 Issue
- 创建 Issue 时必须打全标签（type、stage、module、priority）
- 每日更新 Issue 状态，周日统一汇总到 develop
...
- 单条规则命中只能影响对应标准条款，不得写成整份报告失败。

说明：以下为首批可直接在 GitHub 创建的任务，已按成员职责和里程碑 M1 拆解。

## A. 项目负责人 徐志翔

1. [S1][rules] 冻结标准表、检查项与优先级
- 截止：2026-04-16
...
5. [S1][rules] 字段映射、别名表与条款对齐 V0.1
- 截止：2026-04-16
- 标签：type:feature stage:S1 module:rules priority:P0
- 验收：完成核心字段映射表并经负责人审阅

6. [S1][test] 条款级样本用例设计 V0.1
- 截止：2026-04-19
